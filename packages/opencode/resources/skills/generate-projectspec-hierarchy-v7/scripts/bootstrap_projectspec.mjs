...
async function main() {
  ...
  addDocument(documents, "high-level-architecture.md", "architecture", "workspace", "mandatory architecture overview")
  addDocument(
    documents,
    "constraints-and-limitations.md",
    "constraints-and-limitations",
    multiple ? "workspace" : projects[0]?.id || "workspace",
    multiple ? "mandatory cross-Project governance registry" : "mandatory Project governance registry",
  )
  ...
  const plannedProjects = projects.map((project) => {
    ...
    if (multiple) {
      ...
      addDocument(documents, documentPath(base, "constraints-and-limitations.md"), "constraints-and-limitations", project.id, "Project and module-scoped governance registry")
    }
