...
Do not stop merely because a numeric budget was reached. Stop when the trigger-to-terminal path, material branches, and scoped governance entries are supported; or when additional evidence repeats established facts/cannot change the document.
